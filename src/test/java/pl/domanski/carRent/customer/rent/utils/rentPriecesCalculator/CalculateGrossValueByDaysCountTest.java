...
public class CalculateGrossValueByDaysCountTest {
    ...
    @Test
    void should_calculate_Gross_value_for_6_days() {
        //given
        long days = 6L;
        Car car = createCar();
        //when
    ...
    @Test
    void should_calculate_Gross_value_for_7_days() {
        //given
        long days = 7L;
        Car car = createCar();
        //when
    ...
    @Test
    void should_calculate_Gross_value_for_13_days() {
        //given
        long days = 13L;
        Car car = createCar();
        //when
    ...
    @Test
    void should_calculate_Gross_value_for_14_days() {
        //given
        long days = 14L;
        Car car = createCar();
        //when
    ...
    @Test
    void should_calculate_Gross_value_for_29_days() {
        //given
        long days = 29L;
        Car car = createCar();
        //when
    ...
    @Test
    void should_calculate_Gross_value_for_30_days() {
        //given
        long days = 30L;
        Car car = createCar();
        //when
